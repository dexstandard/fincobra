...
export const developerInstructions = [
  ...
  '- Interpret the shared market_overview.v2 dataset for technical context and the structured newsContext feeds for event risk.',
  ...
  '- Use newsContext.bias to tilt sizing alongside market_overview; cite top in shortReport.',
  '- If any bearish Hack|StablecoinDepeg|Outage with severity ≥ 0.75, allow protective action even if technicals are neutral.',
  '- Return {orders:[{pair:"TOKEN1TOKEN2",token:"TOKEN",side:"BUY"|"SELL",qty:number,limitPrice:number,basePrice:number,maxPriceDivergencePct:number},...],shortReport}.',
