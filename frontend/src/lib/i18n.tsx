...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    ai_api_keys_heading: 'AI API Keys',
    exchange_api_keys_heading: 'Exchange API Keys',
    ...
    binance_futures_balances: 'Binance Futures Balances',
  ...
  ru: {
    ...
    groq_api_key: 'API ключ Groq Responses',
    ai_api_keys_heading: 'API ключи ИИ',
    exchange_api_keys_heading: 'API ключи бирж',
    ...
    binance_futures_balances: 'Балансы фьючерсов Binance',
